...
import { BarChart3, TrendingUp, Users, DollarSign, Calendar as CalendarIcon, Bath } from 'lucide-react';
...
const ReportsPage: React.FC = () => {
  ...
  const bathRevenueData = useMemo(() => {
    ...
    for (let i = numMonths - 1; i >= 0; i--) {
      ...
      let receita = 0, quantidade = 0;
      baths.forEach(b => {
        const bDate = new Date(b.date);
        if (isWithinInterval(bDate, { start, end })) { receita += b.price; quantidade++; }
      });
